...
| Settings-sync selection and credentials | `next_sync_selection`; encrypted `pocketshell-sync-auth` plus AndroidX encrypted-preference keysets | #2860 leaves ciphertext/keysets in place until a reader proves they can be opened; #2852 specifies sync data parity and #2861 owns OAuth lifecycle. |
